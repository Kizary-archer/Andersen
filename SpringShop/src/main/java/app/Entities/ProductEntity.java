...
@Scope("prototype")
@Entity
@Table(name = "product", schema = "public", catalog = "Shop2")
public class ProductEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "manufacture", referencedColumnName = "idmanuf", nullable = false,insertable = false,updatable = false)
